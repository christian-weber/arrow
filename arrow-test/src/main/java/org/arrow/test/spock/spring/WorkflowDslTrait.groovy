...
public trait WorkflowDslTrait {
     ...
     * @return ProcessInstance
     */
    public ProcessInstance await(ProcessInstance pi) {
        pi.waitOnCompletion();
        return pi;
    }
     ...
     */
    public Iterable<ProcessInstance> await(Iterable<ProcessInstance> pis) {
     ...
     * @return Iterable < ProcessInstance >
     */
    public Iterable<ProcessInstance> await(Future<Iterable<ProcessInstance>> pis) {
