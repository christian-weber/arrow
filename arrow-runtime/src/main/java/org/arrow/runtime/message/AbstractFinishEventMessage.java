 ...
 * @since 1.0.0
 */
public abstract class AbstractFinishEventMessage extends AbstractEntityEventMessage implements FinishEventMessage {
	 ...
	 */
	public AbstractFinishEventMessage(BpmnNodeEntitySpecification entity, ProcessInstance processInstance) {
	 ...
	 *            the execution
	 */
	public AbstractFinishEventMessage(Execution execution) {
        super(execution);
	}
