...
/**
 * BPMN 2.0 link intermediate throw event.
 * 
 * @author christian.weber
 * @since 1.0.0
 */
@NodeEntity
@TypeAlias("LinkIntermediateThrowEvent")
public class LinkIntermediateThrowEvent extends AbstractIntermediateThrowEvent
