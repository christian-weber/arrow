 ...
 */
@EventService
public class SignalEventProcessStartingService implements EventMessageService<SignalEventRequest> {
    ...
    /**
     * {@link Callable} implementation class used to find all
     * {@link StartEvent} instances which belongs to the given
    ...
    private class EventMessageCallable implements Callable<Iterable<EventMessage>> {
        ...
        public EventMessageCallable(SignalEventRequest request) {
        ...
        public Iterable<EventMessage> call() throws Exception {
            ...
            startEvents = startEventRepository.findSignalStartEventsByReference(signalRef);
